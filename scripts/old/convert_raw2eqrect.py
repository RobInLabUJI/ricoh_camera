...
def callback(data):
    ...
    back_eqimg  = rotate_ccw_90(equirectangular_projection(back_img,  map1_b, map2_b))

    both_eqimg = np.concatenate((front_eqimg, back_eqimg), axis=1)

    panorama = np.roll(both_eqimg, ROLL, axis=1)
...
if __name__ == '__main__':
    rospy.init_node('convert_raw2eqrect', anonymous=True)
