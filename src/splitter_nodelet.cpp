...
class Splitter : public nodelet::Nodelet
{
...
public:
  ...
  void onInit()
  {
    ...
    image_sub_ = it_->subscribe("image_raw", 1, &Splitter::imageCb, this);
...
PLUGINLIB_EXPORT_CLASS(ricoh_camera::Splitter, nodelet::Nodelet)
